...
//@SlingServlet(resourceTypes="project/components/structure/page",selectors="sample")
...
@Component(
		service=Servlet.class,
		property={
				"sling.servlet.resourceTypes="+ "project/components/structure/page","sling.servlet.selectors="+"sample"
		}
)
